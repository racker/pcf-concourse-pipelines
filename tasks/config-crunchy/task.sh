...
PRODUCT_PROPERTIES=$(
  ...
  --argjson extra-large_postgresql_instance_count $EXTRA-LARGE_POSTGRESQL_INSTANCE_COUNT \
  --argjson extra-large_postgresql_service_quota $EXTRA-LARGE_POSTGRESQL_SERVICE_QUOTA \
